...
global.__dirMiddleware = __dirname + '/app/Middleware/';
global.__dirApi = __dirname + '/app/api/';
global.__dirV1 = __dirname + '/app/api/v1/';
global.__dirPublic = __dirname + '/public/';
global.__dirUtil = __dirname + '/app/Utility/';
global.__dirStorage = __dirname + '/storage/';